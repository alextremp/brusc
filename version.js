...
const AUTHOR = 'Travis CI <travis@travis-ci.org>'
...
commands.push(`git remote add origin ${REPO} > /dev/null 2>&1`)
commands.push('git add package.json')
commands.push(`git commit -m "${MESSAGE}" --author="${AUTHOR}"${NOLOG}`)
